...
public class ResourceManager {
    ...
    public Sprite getCreatureBullet() {
    	return this.creatureBulletSprite;
    }
    ...
    */
    ...
    public TileMap loadCustomizedMap(String filename) {
        TileMap map = null;
    ...
    private void loadBullet() {
    	...
    	animRight.addFrame(loadImage("bullet.png"), 150);
    	animLeft.addFrame(getMirrorImage(loadImage("bullet.png")), 150);
    	bulletSprite = new Bullet(animRight,animLeft,animRight, animLeft);
    }
    private void loadCreatureBullet() {
    	Animation animRight = new Animation();
    	Animation animLeft = new Animation();
    	animRight.addFrame(loadImage("creatureBullet.png"), 150);
    	animLeft.addFrame(getMirrorImage(loadImage("creatureBullet.png")), 150);
    	creatureBulletSprite = new CreatureBullet(animRight,animLeft,animRight, animLeft);
    }
    private void loadGasBlock() {
    	 Animation anim = new Animation();
    	 anim.addFrame(loadImage("gas.png"), 150);
    	 gasSprite = new PowerUp.Gas(anim);
    }
    private void loadExplodeBlock() {
   	 Animation anim = new Animation();
   	 anim.addFrame(loadImage("TNT.png"), 150);
